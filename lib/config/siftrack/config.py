...
cfg.DATA.DYNAMIC = edict()
cfg.DATA.DYNAMIC.NUMBER = 1
cfg.DATA.DYNAMIC.SIZE = 192
cfg.DATA.DYNAMIC.FACTOR = 3.0
cfg.DATA.DYNAMIC.CENTER_JITTER = 0
cfg.DATA.DYNAMIC.SCALE_JITTER = 0
...
cfg.TEST.DYNAMIC_FACTOR = 3.0
cfg.TEST.DYNAMIC_SIZE = 192
